...
A single-user CLI habit tracker: one command logs a habit, one shows the week; plain-text store, no accounts.

Before any work: read docs/STATE.md, then docs/ARCHITECTURE.md and
docs/CONVENTIONS.md. Confirm your understanding of your task in one
