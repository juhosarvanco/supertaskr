//! `supertaskr-index index --watch` — keep graph.json current, headless.
//!
...
const CONFIG_NAMES: [&str; 4] = ["tsconfig.json", "package.json", ".gitignore", ".supertaskrignore"];
...
mod tests {
    ...
    fn an_invalid_root_fails_the_run_rather_than_watching_nothing() {
        let opts = IndexOptions {
            root: PathBuf::from("/nonexistent/supertaskr-t014-watch"),
            ..Default::default()
        };
