# Competitive map — August 2026 (merged draft, NOT YET LANDED)

DRAFT proposed 2026-08-30 by the marketing session as the replacement
for docs/research/competitors.md — the 2026-08-25 "Four missing
competitors" addendum folded in with its ⚠ claims re-verified (record:
docs/business/competitors-merge-proposal.md). The architect lands it
on @human's M1 ruling; until then the landed map is authoritative.
