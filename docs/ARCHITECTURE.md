...
| C-05 | App | Front door (ADR-008): Tauri shell + panes over files; hosts the milestone-1 watcher (T-003); see docs/design/dashboard.md | C-01, C-06 | building (shell + watcher done T-001/T-003; board pending T-004–T-006) |
