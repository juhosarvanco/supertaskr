...
| C-05 | App | Front door (ADR-008): Tauri shell + panes over files; hosts the milestone-1 watcher (T-003); see docs/design/dashboard.md | C-01, C-06; C-07 when F-06 lands | building (shell, watcher, board, detail panel, picker done — T-001/T-003/T-004/T-005/T-007; design pass T-006 pending) |
