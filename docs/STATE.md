...
2. **NO LANE IS LIVE.** The order the owner ruled 2026-09-17 is spent
   as far as it can go: T-344, T-332, T-335 and T-295-s8 merged.
   **T-311 and T-314 are `suggested` and block five of the eight
   remaining grant cards**; T-205-s5 is the only unblocked one and it
   collides with T-204. Four decisions wait on the owner —
   supertaskr-evidence/NIGHT-2026-09-17.md names them. Lanes in
