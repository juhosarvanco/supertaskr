...
- **Capabilities** (`docs/CAPABILITIES.md`) — What this app does, one sentence per behaviour the e2e suite runs. **Open it at:** accelerators · blocker-retarget · boot-check-guard · brief-flush · brief · card-figures · +34 more
