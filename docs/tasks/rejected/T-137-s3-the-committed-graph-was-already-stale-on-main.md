...
Disposition 2026-09-13 (the pruning sitting (T-306), the owner's ruling of 2026-09-13): discharged — the work landed elsewhere: T-295 (done). the merge arm regenerates the graph, runs `index --check`, and re-asks it after every correction, so a stale graph is caught at its own merge.
