...
Filed by the T-205-s8 lane as T-205-s7, an id the seat had already absorbed into another card at 866ac33 (its text lives there under an Absorbs heading); renumbered T-205-s11 at the merge so one id names one subject.
