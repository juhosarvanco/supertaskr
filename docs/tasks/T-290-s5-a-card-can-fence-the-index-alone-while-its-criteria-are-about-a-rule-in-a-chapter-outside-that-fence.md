...
priority: 1
status: suggested
suggested_by: "executor claude-opus-5@subagent @T-290, derived from the fence census at the lane's tip: 74 non-done cards fence the index whole and 1 of them also fences a chapter"
blocked_by: []
...
Measured at T-290's tip: 136 cards fence the index whole, 74 of them not
done and 45 of those planned; ONE of the 74 also fences a chapter. Every
one of the other 73 will be dispatched with a fence that cannot reach
the rule its criteria are about, and the first thing each lane meets is
a write hook refusing the only file that matters.
