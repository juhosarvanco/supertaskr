...
touches: [method/adapters/AGENTS.md, method/skills/supertaskr-seat/SKILL.md, tools/e2e/scripts/brief.mjs, tools/e2e/scripts/adapter-codex.mjs, tools/e2e/tests/adapter-codex.spec.ts, docs/CONVENTIONS.md]
builder:
verifier:
built_by:
verified_by:
