...
blocked_by: []
touches: [method/roles/orchestrator.md, method/rooms/ROOM-FORMAT.md, method/docs-templates/decisions/000-template.md, tools/method-evals/, docs/CONVENTIONS.md]
builder:
verifier:
built_by:
verified_by:
...
- The method stamp SHALL be bumped at the merge (the role file and the templates are kit files), and CONVENTIONS' records bullet SHALL point at the rule in one line.
