...
The fourth reading's second half (the architect seat, 2026-09-09T12:32Z, from run 34348711057 on 6ee2eab — GREEN): on image 20260831.293.1 the free-disk step measured and removed /usr/share/dotnet 5.6G, /usr/local/lib/android 11G, /usr/local/.ghcup 3.7G, /opt/hostedtoolcache/CodeQL 1.8G, /usr/share/swift 3.3G (/opt/ghc absent, skipped) — `freed 28358404 KiB on / (186968 KiB free before, 28545372 KiB after)` — and the floor read 28,545,320 KiB against 2,097,152. The 2 GiB floor now sits 26 GiB under the reading on the image that used to fail it; re-derive it from this and the newer image's reading when one lands.
