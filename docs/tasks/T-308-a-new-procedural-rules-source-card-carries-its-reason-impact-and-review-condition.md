...
blocked_by: []
touches: [method/docs-protocol.md, method/tasks/TASK-FORMAT.md, docs/CONVENTIONS.md, docs/conventions/records-and-rooms.md]
builder:
verifier:
built_by:
verified_by:
...
**Fence re-pointed 2026-09-14 (the architect seat, after T-290's merge).** docs/CONVENTIONS.md is now the index over the chapters under docs/conventions/; this fence gains the chapter(s) this card's work needs, mapped by the paths its fence reserves and the words its title uses: docs/conventions/records-and-rooms.md. The index stays fenced for its pointer line.
