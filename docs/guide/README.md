...
It is built for one person with an AI coding agent and a real project
that is outgrowing their control: the solo founder with abandoned
vibe-coded repos who cannot turn ideas into plans, and the developer
with a months-old session and no system.

This guide is four short pages. Read them in order the first time.
...
and not yet landed, as of 2026-09-08. Nothing here is the exact
behaviour list. That list is generated from the tests and lives in
