# Backfill record (2026-08-27): docs/STATE.md verbatim at ADR-019's ratification

Phase 1 of docs/rooms/governing-docs.md, executed at @human's
direction. Everything below the rule is docs/STATE.md byte-verbatim at
`9d09a07` (69,837 bytes, the file clean against HEAD when copied),
preserved BEFORE any compaction cut anything. Nothing below is
current: it is a RECORD in ADR-019's sense — written once, never
edited, and never to be depended on by any suite, gate or generator.
Derive at your own ref.
